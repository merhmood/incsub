            ...
            if (action.value.length === 0) {
                return ({
                    ...
                    formDataPassword: {
                        ...
                        error: { ...state.formDataPassword.error, pColor: 'red', pTextColor: 'red', value: false }
                ...
                return ({
                    ...
                    formDataPassword: {
                        ...state.formDataPassword,
                        error: { ...state.formDataPassword.error, pColor: 'red', pTextColor: 'red', value: true }
                    }
                })
            }
                ...
                return ({
                    ...
                    formDataPassword: {
                        ...state.formDataPassword,
                        error: { ...state.formDataPassword.error, pColor: 'black', pTextColor: 'green', value: true }
                    }
                })
            }
        }
    ...
    if (action.type === "AUTO-FOCUS") {
        if (action.value === 1) {
            ...
            return ({
                ...
                formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, eColor: 'black' } }
            })
        }
            ...
            if (action.formData.password.length === 0) {
                return ({
                    ...
                    formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: 'black', pTextColor: 'black', value: false } }
                })
            }
            else if (action.formData.password.length >= 8) {
                return ({
                    ...state, style: { ...state.style, three: { top: '-0.6em', fontSize: '0.6rem', transition: 'top 0.2s, fontsize 0.2s' } },
                    formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: 'black', pTextColor: 'green', value: true } }
                })
            }
            else if (action.formData.password.length < 8) {
                return ({
                    ...state, style: { ...state.style, three: { top: '-0.6em', fontSize: '0.6rem', transition: 'top 0.2s, fontsize 0.2s' } },
                    formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: 'red', pTextColor: 'red', value: true } }
                })
            }
            else {
                return ({
    ...
    if (action.type === "BLUR") {
        if (action.value === 1 && action.formData.name.length === 0) {
            ...
            return ({
                ...
                formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, eColor: '#cccccc' } }
            })
        }
        else if (action.value === 3 ) {
            console.log(state)
            if (action.formData.password.length === 0) {
                ...
                formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: '#cccccc', pTextColor: 'black' } }
            })
            }
            else if (action.formData.password.length > 0 && action.formData.password.length < 8) {
                return ({
                ...state, style: { ...state.style, three: { top: '-0.6em', fontSize: '0.6rem', transition: 'top 0.2s, fontsize 0.2s' } },
                formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: 'red', pTextColor: 'red' } }
            })
            }
            else if (action.formData.password.length >= 8) {
                return ({
                ...state, style: { ...state.style, three: { top: '-0.6em', fontSize: '0.6rem', transition: 'top 0.2s, fontsize 0.2s' } },
                formDataPassword: { ...state.formDataPassword, error: { ...state.formDataPassword.error, pColor: '#cccccc' } }
            }) 
            } 
        }
        else {
